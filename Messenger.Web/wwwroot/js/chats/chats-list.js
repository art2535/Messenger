/* chats-list.js — loadChats, history pagination, last message preview */
        ...
        async function loadMessages(chatId) {
            ...
            try {
                ...
                // При загрузке сообщений всегда показываем вкладку закреплённых (если есть)
